          ...
          <Masonry columns={{ xs: 1, md: 2 }} spacing={3}>
            ...
            <Block title="Grouped" sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <AvatarGroup max={4}>
                <Avatar
                  alt="Remy Sharp"
                  src="/static/avatars/avatar_4.jpg"
                />
                <Avatar color="info">OP</Avatar>
                <Avatar
                  alt="Cindy Baker"
                  src="/static/avatars/avatar_5.jpg"
                />
                <Avatar
                  alt="Agnes Walker"
                  src="/static/avatars/avatar_6.jpg"
                />
                <Avatar
                  alt="Trevor Henderson"
                  src="/static/avatars/avatar_7.jpg"
                />
                <Avatar
                  alt="Trevor Henderson"
                  src="/static/avatars/avatar_8.jpg"
                />
                <Avatar
                  alt="Trevor Henderson"
                  src="/static/avatars/avatar_9.jpg"
                />
              </AvatarGroup>
            </Block>
